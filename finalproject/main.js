...
function displayCart() {
    ...
    if(cartItems && productContainer) {
        ...
        Object.values(cartItems).map( (item, index) => {
            productContainer.innerHTML += 
            `<div class="product"><ion-icon name="close-outline"></ion-icon><img src="./images/${item.tag}.jpg" width="100" height="100">
...
// tutorials that helped me with this project!
// https://www.youtube.com/watch?v=B20Getj_Zk4&t=698s
